...
function AddNew() {
	...
	return (
		<div className='d-flex flex-column align-items-center pt-4 loginForm loginPage'>
			<h5>WELCOME TO HARVESTERS INTERNATION CHRISTIAN CENTER IBADAN CAMPUS</h5>
            <h5>PLEASE KINDLY FILL THE FORM BELOW, SO WE CAN GET TO KNOW YOU BETTER</h5>
			...
			<div class="col-12">
				...
				<div class="col-12">
					<button type="submits" class="btn btn-primary">Register</button>
				</div>
			</form>
		</div>
